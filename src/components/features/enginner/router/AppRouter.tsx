...
import { RequestOrders } from '../components/pages/RequestOrders';
import { BorrowRequests } from '../components/pages/BorrowRequests';
import { PurchaseRequests } from '../components/pages/PurchaseRequests';
import { TransferRequests } from '../components/pages/TransferRequests';
import { MyInventoryTransfer } from '../components/pages/MyInventoryTransfer';
import { CompleteHistory } from '../components/pages/CompleteHistory';
