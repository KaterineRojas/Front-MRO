...
export function DismantleKitModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div 
        className={`relative w-full max-w-lg bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden transition-all duration-300 ease-out ${
          isVisible 
      ...
      >
        ...
        <div className="flex flex-col space-y-1.5 p-6 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={handleClose}
              className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 transition-colors focus:outline-none hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-1"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              disabled={isSubmitting}
              rows={3}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:!border-orange-500 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 sm:text-sm disabled:opacity-50 disabled:bg-gray-100 dark:disabled:bg-gray-900 resize-none transition-all"
        ...
        <div className="p-6 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/50 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-white bg-orange-600 border border-transparent rounded-lg shadow-sm hover:bg-orange-700 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all min-w-[140px]"
          >
            {isSubmitting ? (
              <>
